      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-emerald-500 to-green-500 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            ...
            <p className="text-emerald-50 text-lg mb-8 leading-relaxed">
              Access exclusive deals, track your orders, and enjoy a personalized shopping experience at Chasmawala.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="text-white font-semibold">Exclusive Discounts</h3>
                  <p className="text-emerald-100 text-sm">Get up to 50% off on premium eyewear</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="bg-white/20 p-2 rounded-lg mt-1">
                ...
                <div>
                  ...
                  <p className="text-emerald-100 text-sm">Free shipping on orders above ₹1199</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="bg-white/20 p-2 rounded-lg mt-1">
                ...
                <div>
                  ...
                  <p className="text-emerald-100 text-sm">30-day return policy, no questions asked</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10">
          <p className="text-emerald-100 text-sm">
            Trusted by 5000+ customers across Nepal
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-gray-100">
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl text-white font-semibold transition-all duration-200 ${
                  loading
                    ...
                    : "bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40"
                }`}
                disabled={loading}
              >
                {loading ? (
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600 text-sm">
                ...
                <a href="/account/signup" className="text-emerald-600 hover:text-emerald-700 font-semibold transition-colors">
                  Create Account
                </a>
              </p>
            </div>
